...
<html lang="en">
  ...
  <head>
    ...
    <title>Sanchith's Admin Panel - Add Testimonials</title>
					...
					$.ajax({
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="quantity" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="quantity"  type="number">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
 			 <input id="size" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="size"  type="text">
                    ...
                    <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="material" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="material"  type="text">
