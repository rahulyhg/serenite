              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
                  <form class="form-horizontal form-label-left" novalidate action="lib/process.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" value="logos" name="type">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="file" id="image" name="image" required="required"  class="form-control col-md-7 col-xs-12"> <span style="color:red;">1170 width by 500 height</span>
                       </div>
                     </div>
                     <div class="item form-group">
