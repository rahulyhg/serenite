...
<html lang="en">
  ...
  <head>
    ...
    <title>Sanchith's Admin Panel - Edit Mattress</title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                $result=aGetAllDetailsByGroup("mattress",$_REQUEST['id']);
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" novalidate action="lib/process.php" method="post" enctype="multipart/form-data">
                      ...
                      <input type="hidden" value="mattress" name="type">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input id="size" value="<?php echo $result[0]['size']; ?>" name="size" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text"> 
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input id="url" value="<?php echo $result[0]['url']; ?>" name="url" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                    ...
                    <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input id="material" value="<?php echo $result[0]['material']; ?>" name="material" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Comfort level

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                         <input id="comfort_level" value="<?php echo $result[0]['comfort_level']; ?>" name="comfort_level" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Mattress type

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                    	<input id="mattress_type" value="<?php echo $result[0]['mattress_type']; ?>" name="mattress_type" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Recommended

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                         <input id="recommended" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="recommended" value="<?php echo $result[0]['recommended'];?>" type="text">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Made up for

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                         <input id="made_up_for" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="made_up_for" value="<?php echo $result[0]['made_up_for']; ?>" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Warranty

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                         <input id="warranty" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="warranty" value="<?php echo $result[0]['warranty']; ?>"  type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Colors

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                         <input id="colors" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="<?php echo $result[0]['colors']; ?>" name="colors"  type="text">
