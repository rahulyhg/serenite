...
<html lang="en">
  ...
  <head>
    ...
    <title>Sanchith's Admin Panel - Edit Pillows</title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                $result=aGetAllDetailsByGroup("pillows",$_REQUEST['id']);
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" novalidate action="lib/process.php" method="post" enctype="multipart/form-data">
                      ...
                      <input type="hidden" value="pillows" name="type">
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Size
                    	 ...
                    	 <input id="size" class="form-control col-md-7 col-xs-12" value="<?php echo $result[0]['size'];?>" data-validate-length-range="6"  name="size"  type="text">
                    ...
                    <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="material" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="material" value="<?php echo $result[0]['material'];?>" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <?php $selected= $result[0]['comfort_level'];?>

                        <select id="comfort_level" name="comfort_level"  class="control-label col-md-3 col-sm-3 col-xs-12">

                          <option <?php if($selected=='soft') echo 'selected'; ?> value="soft">Soft</option>

                          <option <?php if($selected=='firm') echo 'selected'; ?> value="firm">Firm</option>

                          <option <?php if($selected=='hard') echo 'selected'; ?> value="hard">Hard</option>
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Pillow type

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

                       <?php $selected=$result[0]['pillow_type'];?>

                          <select id="pillow_type" name="pillow_type"  class="control-label col-md-3 col-sm-3 col-xs-12">

                          <option <?php if($selected=='neck') echo 'selected'; ?> value="neck">Neck</option>
