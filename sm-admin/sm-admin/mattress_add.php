...
<html lang="en">
  ...
  <head>
    ...
    <title>Sanchiths Admin Panel - Add mattress</title>
				...
				function checkid()
				{
					...
					$.ajax({
                     ...
                     <div class="item form-group">
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Quantity available
                       ...
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Mattress video URL

                       </label>

                       <div class="col-md-6 col-sm-6 col-xs-12">

			<input id="url" name="url" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                    ...
                    <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input id="material" name="material" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                    ...
                    <input id="comfort_level" name="comfort_level" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
			<input id="mattress_type" name="mattress_type" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="recommended" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="recommended"  type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="made_up_for" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="made_up_for"  type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="warranty" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="warranty"  type="text">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="colors" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="colors"  type="text">
