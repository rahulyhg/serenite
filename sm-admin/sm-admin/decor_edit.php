...
<html lang="en">
  ...
  <head>
    ...
    <title>Sanchith's Admin Panel - Edit Decor</title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                $result=aGetAllDetailsByGroup("decor",$_REQUEST['id']);
                  ...
                  <form class="form-horizontal form-label-left" novalidate action="lib/process.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="item form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="content" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="<?php echo $result[0]['content']; ?>" name="content"  type="text">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input id="category" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="<?php echo $result[0]['category']; ?>" name="category"  type="text">
