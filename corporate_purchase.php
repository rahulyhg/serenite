...
<div class="container"><ol class="breadcrumb">		  <li><a href="index.php">Home</a></li>		  <li class="active">Corporate Purchase</li>		 </ol></div>
<div  class="container">
﻿
 <div  class="container" style="font-size: 13pxbackground-color: white">
﻿<center>
	<h2 style="color:#ff751a">Corporate Purchase</h2>
	</br>
...
﻿        Swedish nature﻿Vividus﻿Our Story﻿Accessories﻿Smart<br>
       ...
       Are you an interior designer, specifier or architect
       wanting to bring serenite to your clients?<br>

      If you are an industry design professional, architect 
      or stylist then we encourage you to join our serenite
      Interior Design Program As a member you will be able 
      to work directly with your local store to bring 160<br>
      years of craftsmanship to your clients and projects
   ...
   - Current Business or State Profession License, in a Residential or 
     Commercial Design-based business, or the Hospitality industry
   ...
   - Resale of Sales Tax Certificate
   - A professional portfolio or website<br>
...
<div   class="col-sm-12 col-md-6 col-lg-6">
           <div id="form">
               ...
               <div class="formgroup" id="name-form">
                    <input class="form-control" placeholder="Name of company" type="text" id="name" name="name_of_company" required autofocus autocomplete="off"/>
               </div>
                ...
                <div class="formgroup" id="contact-form">
                     <input class="form-control" placeholder="point of contact" type="text" id="point of contact" name="point_of_contact" required autocomplete="off"/>
                </div>

                <div class="formgroup" id="requirement-form">
                     <input class="form-control" placeholder="requirement" type="text" id="requirement" name="requirement" required autocomplete="off" />
                </div>

                <div class="formgroup" id="quantity-form">
                     <input class="form-control" placeholder="approx quantity" type="number" id="approx quantity" name="approx_quantity" required autocomplete="off"/>
                </div>

                <div class="formgroup" id="date-form">
                    <input class="form-control" placeholder="date to contact" name="date_to_contact"  onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" required />
                </div>
                 
                 <div class="formgroup" id="time-form">
                    <input class="form-control" placeholder="time to contact" name="time_to_contact"  onfocus="(this.type='time')" onblur="if(this.value==''){this.type='text'}" required />
                </div>
        

                <div class="formgroup" id="expectation-form">
                    <input class="form-control" placeholder="expectation" type="text" id="expectation" name="expectation" autocomplete="off" required />
                </div>

          <input class="form-control" type="submit" value="Proceed" />
               <input  name="from" value="corporate_purchase" type="hidden"/>
         </form>
    </div>
</div>
         ...
         <div class="bikes-grids">           
             ...
             <ul id="flexiselDemo1">
                 ...
                 <li>
                                     ...
                                     <a href="#l"><img src="images/clogo.png" alt=""/></a>       

                 </li>

                 <li>

                                     <a href="p#"><img src="images/elogo.png" alt=""/></a>  

                 </li>

                 <li>

                                     <a href="#"><img src="images/hlogo.png" alt=""/></a>
                 ...
                 <li>
                                     ...
                                     <a href="#"><img src="images/sllogo.png" alt=""/></a>                   

                 </li>

                                  <li>

                                      <a href="#"><img src="images/slogo.png" alt=""/></a>                   

                 </li>

                                  <li>

                                      <a href="#"><img src="images/rlogo.jpg" alt=""/></a>                   

                 </li>

                                  <li>

                                      <a href="#"><img src="images/reclogo.jpg" alt=""/></a>                     

                 </li>

                                  <li>

                                      <a href="#"><img src="images/plogo.jpg" alt=""/></a>                   
