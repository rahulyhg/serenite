...
<?php include 'header.php';?><div class="container"><ol class="breadcrumb">		  <li><a href="index.php">Home</a></li>		  <li class="active">Partner with us</li>		 </ol></div>

<div  class="container" >
﻿
<div  class="container" style="font-size: 13pxbackground-color: white">
﻿<center>
	<h2 style="color:#ff751a">Partner With Us</h2>
	</br>
...
<div   class="col-sm-12 col-md-6 col-lg-6">
           <div id="form">
               ...
               <div class="formgroup" id="name-form">
                ...
                <div class="formgroup" id="contact-form">
                     <input class="form-control" placeholder=" contact name" type="text" id="contact name" name="contact_name" required autocomplete="off" />
                </div>

                <div class="formgroup" id="years-form">
                     <input class="form-control" placeholder="years in industry" type="number" id="years in industry" name="years_in_industry" required autocomplete="off"/>
                </div>
          ...
          <input class="form-control" type="submit" value="Proceed" />
           <input name="from" value="partner_with_us" type="hidden"/>
         </form>
    </div>
</div>
